 ...
 *
 * Only reads seasonName/totalPoints, so it also works for a club's season
 * totals (metrics/teamStats.ts clubSeasonHistory) — not just a single
 * player's real PlayerSeasonHistory.
 */
