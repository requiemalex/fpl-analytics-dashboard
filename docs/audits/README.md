...
| `results/2026-09-25-player-team-profiles/` | Player profile and Team Profile overlays | `1-audit.md` | Phase 1: 0 C, 2 H, 5 M, 10 L, 2 V. H1: radars and percentile tints have no minutes threshold (cameos top per-game axes), fix needs the owner's decision; H2: pre-season, Career History's live season repeats last season. 6 `it.fails` tests added for H2, M2–M5, L1 |
